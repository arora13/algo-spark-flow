...
const AbstractGradientBackground = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      {/* Baby blue blur zones for cards */}
      <div className="absolute top-32 left-1/4 w-80 h-80 bg-baby-blue-blur rounded-full blur-3xl opacity-30 animate-pulse-gentle" />
      <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-baby-blue-blur rounded-full blur-3xl opacity-25 animate-pulse-gentle" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-32 left-1/2 w-72 h-72 bg-baby-blue-blur rounded-full blur-3xl opacity-35 animate-pulse-gentle" style={{ animationDelay: '4s' }} />
